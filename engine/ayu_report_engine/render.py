...
from .png_renderer import PNG_SCRIPT
...
<nav class="nav" aria-label="报告导航"><a href="#today" class="active" aria-current="page">总览</a><a href="#structure">训练结构</a><a href="#evidence">关键证据</a><a href="#load">近期负荷</a>__TOMORROW_NAV__</nav>
...
<script id="png-report" type="application/json">__PNG_JSON__</script><script>__PNG_SCRIPT__</script></body></html>'''
