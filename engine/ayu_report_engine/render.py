...
<head>
  ...
  <style>
    :root {{ color-scheme:dark; --bg:#080B09; --panel:#0D120F; --green:#56FFA3; --orange:#FFB86B; --text:#F2F6F3; --muted:rgba(242,246,243,.62); --line:rgba(86,255,163,.25); }} * {{ box-sizing:border-box; }} html {{ scroll-behavior:smooth; }} body {{ margin:0; background:var(--bg); color:var(--text); font-family:"Microsoft YaHei","PingFang SC",system-ui,sans-serif; background-image:linear-gradient(rgba(86,255,163,.035) 1px,transparent 1px),linear-gradient(90deg,rgba(86,255,163,.035) 1px,transparent 1px); background-size:90px 90px; }}
